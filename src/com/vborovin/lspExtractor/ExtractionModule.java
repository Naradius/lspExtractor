...
public class ExtractionModule {
        ...
        if (childAnnot.isPresent()) {
            ...
            if (node.isServiceLevel()) {
                ...
                if (nodeChildren != null && nodeChildren.length > 1) {
                    ...
                    //Split ONLY if all children are phrase/service
    ...
    public HashMap<String, ArrayList<ExtendedParse>> calculateDistribution(ArrayList<ExtendedParse> parsePhrases) {
        ...
        //HashMap<Integer, ArrayList<ExtendedParse>> phraseDistributionDepth = new HashMap<>();
        ...
        for (ExtendedParse phrase : parsePhrases) {
            ...
            /*int depth = phrase.getDepth();
            if (phraseDistributionDepth.containsKey(depth)) {
                ArrayList<ExtendedParse> phraseList = phraseDistributionDepth.get(depth);
                phraseList.add(phrase);
            } else {
                ArrayList<ExtendedParse> phraseList = new ArrayList<>();
                phraseList.add(phrase);
                phraseDistributionDepth.put(depth, phraseList);
            }*/
        }
    ...
    public void debugPrintDistribution(ArrayList<ExtendedParse> parsePhrases, HashMap<String, ArrayList<ExtendedParse>> phraseDistribution) {
        try {
            ...
            //PrintWriter outDepth = new PrintWriter("distributionDepth.csv");
            long soloCount = 0;
            ...
            /*for (int depth : phraseDistributionDepth.keySet()) {
                ArrayList<ExtendedParse> phrases = phraseDistributionDepth.get(depth);
                outDepth.println(depth + "\t" + phrases.size());
            }*/
